...
# Review
"""
Test 5de not yerine x yazılmış
Test 6da çarpım sonuçları yerine tablo şeklinde yazılması gerekli
Test 11de inheritance kullanılmamış. Hayvan türlerinin ayrı instancelar olarak değil
ayrı classlar olarak tanımlanması gerekli.
Genel anlamda iyi ancak istenen input tiplerine göre hata ayıklaması yapılabilir. Cevaplar fonksiyonlar şeklinde yazılabilir.
